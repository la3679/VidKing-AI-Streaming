    ...
    <nav className="w-20 border-r border-line flex flex-col items-center py-8 gap-12 bg-sidebar/70 backdrop-blur-xl shrink-0 h-full z-50">
      ...
      <div className="flex flex-col gap-10 mt-4">
        ...
        >
          ...
          <span className="absolute left-16 bg-brand text-onaccent text-[10px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none uppercase font-black z-50">Home</span>
        </button>
        <button
          type="button"
          onClick={() => {
        ...
        >
          ...
          <span className="absolute left-16 bg-ink text-onaccent text-[10px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none uppercase font-black whitespace-nowrap z-50">My List</span>
        </button>
      </div>
      ...
      <div className="mt-auto flex flex-col gap-8">
        ...
        >
          <span className="w-full h-full bg-ink rounded-[10px] overflow-hidden flex items-center justify-center text-[10px] font-black italic text-onaccent">AI</span>
        </button>
      </div>
    </nav>
  );
